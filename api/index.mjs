...
[검증 기준]
아래에 하나라도 해당되지 않을 시, false 처리하시오.
...
5. 전혀 관련없는 법령 조문을 질문 및 해설에 끼어넣었는가? (시행령도 예외없음)
6. 조항 적용 대상이 소비자, 본인이 아니라 다른 대상인가? (e.g. 전자상거래 등에서의 소비자보호에 관한 법률 제27조 적용 대상은 소비자가 아니라 공정거래위원회, 시·도지사 또는 시장·군수·구청장이다.)
